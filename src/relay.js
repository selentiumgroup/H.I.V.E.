...
export class RelayService {
  constructor({config,identity,store,descriptor,onInfer,onValidate,onCommit,onTransaction,onEvolution,onLearning,onEvolutionAnchorValidate,onTelemetry,onConsensus,onGovernance,guard}){
    this.c=config;this.identity=identity;this.store=store;this.descriptor=descriptor;this.onInfer=onInfer;this.onValidate=onValidate;this.onCommit=onCommit;this.onTransaction=onTransaction;this.onEvolution=onEvolution;this.onLearning=onLearning;this.onEvolutionAnchorValidate=onEvolutionAnchorValidate;this.onTelemetry=onTelemetry;this.onConsensus=onConsensus;this.onGovernance=onGovernance;this.guard=guard;
